...
public class ClientStateMachine {
    ...
    public List<Integer> getTransitionInteger(int goalStatus) {
		List<ClientState> clientStates = getTransition(goalStatus);
		List<Integer> clietStateValues = new LinkedList<Integer>();
		for (ClientState cs : clientStates) {
			clietStateValues.add(cs.getValue());
		}
		return clietStateValues;
    }
